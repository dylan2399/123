...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity.authorizeRequests().antMatchers("/update-password-first-time", "/update-password-first-time/")
	.permitAll();
    ...
    httpSecurity.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(jwtAuthenticationEntryPoint)
        ...
        .permitAll().antMatchers("/assets/**").permitAll().antMatchers("/categories/**").permitAll()
            .antMatchers("/reports/**").permitAll()
            .antMatchers("/return-requests/**").permitAll()
            .antMatchers("/assignments/**").permitAll().anyRequest().authenticated();
